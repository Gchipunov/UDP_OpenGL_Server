...
// send_receive-main_v2.cpp
// 
// g++ -std=c++17 -Wall -o send_receive-main_v2 send_receive-main_v2.cpp -pthread
...
public:
    ...
    void receive_loop() {
        ...
        while (true) {
            ...
            std::string broadcast_message = "[" + std::string(client_ip) + ":" + std::to_string(client_port) + "]: " + message;
            send_queue.push(broadcast_message);
        }
    }
